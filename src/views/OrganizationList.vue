        ...
        <table>
            ...
            <tbody>
                ...
                :class="{ disabledRow: organization.disabled }">
                    ...
                    <td>
                        <!-- Edit Button -->
                        <router-link :to="{ name: 'organization.edit', params: { id: organization.id } }">
                            <button class="edit-button">Edit</button>
                        </router-link>
                        <!-- Optional: Delete Button -->
                        <button class="delete-button" @click="deleteOrganization(organization.id)">Delete</button>
                    </td>
                </tr>
            </tbody>
        </table>
    ...
    methods: {
        ...
        deleteOrganization(id) {
            if (confirm('Are you sure you want to delete this organization?')) {
                axios.delete(`http://127.0.0.1:8000/organizations/${id}`)
                    .then(() => {
